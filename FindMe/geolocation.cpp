...
GeoLocation::GeoLocation()
{
    ...
    {
        fm_geoPositionInfo->setPreferredPositioningMethods(QGeoPositionInfoSource::NonSatellitePositioningMethods);
...
void positionUpdated(QGeoPositionInfo geoPositionInfo) {
    qDebug()<<"Position Updated:" <<geoPositionInfo.coordinate().latitude();
}
